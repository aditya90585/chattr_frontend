...
const PostsLoader = () => {
    return (
        <div className=" w-[100%] h-[80%] relative -z-10 md:mt-0 sm:mt-0 mt-[10%] rounded-xl overflow-hidden drop-shadow-2xl">
            ...
            <div className="flex p-8 justify-center items-center h-[450px]">
              ...
              <div className='w-full h-5 flex justify-center items-center'>
                                    <img className='w-[14%] object-cover' src="/images/chattrLogo.png" alt="LOGO" />
