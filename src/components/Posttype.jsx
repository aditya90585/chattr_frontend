...
const Posttype = ({ createSelectorState, setOpen }) => {
    return (
        <div className={`${createSelectorState ? "flex" : "hidden"} border items-center justify-around flex-col  border-gray-900 md:rounded-xl sm:rounded-xl rounded-md bg-white absolute md:h-25 sm:h-25 h-12 md:mt-6 sm:mt-6 mt-0 md:top-7/9 -top-12 md:left-0 sm:left-0 left-4/6 md:w-[96%] sm:w-[96%] w-30 md:text-2xl sm:text-2xl text-base `}>
